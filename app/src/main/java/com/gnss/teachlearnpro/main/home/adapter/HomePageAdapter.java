...
public class HomePageAdapter extends BaseMultiItemQuickAdapter<MultipleItemEntity, BaseViewHolder> {
    ...
    private void createClasses(BaseViewHolder baseViewHolder, MultipleItemEntity multipleItemEntity) {
        ...
        if (adapter == null) {
            adapter = new HomeClassesAdapter(R.layout.item_grid, classes);
        }
